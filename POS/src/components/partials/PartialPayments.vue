<!--
  ...
  //// Here: import and call wraps, and quote style.
  ...
  //// Neoffice — the c3aabf7 line below is an UPSTREAM commit, blamed to the fork by mistake
  //// by the May 2026 index; partial payments themselves are upstream's feature.
